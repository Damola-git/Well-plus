...
void _reminderSerialize(
  ...
  writer.writeString(offsets[2], object.medicineId);
...
Reminder _reminderDeserialize(
  ...
  object.medicineId = reader.readString(offsets[2]);
  object.status =
      _ReminderstatusValueEnumMap[reader.readByteOrNull(offsets[3])] ??
...
P _reminderDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 3:
      return (_ReminderstatusValueEnumMap[reader.readByteOrNull(offset)] ??
...
const _ReminderstatusValueEnumMap = {
  ...
  1: ReminderStatus.taken,
  2: ReminderStatus.missed,
};
...
extension ReminderQueryFilter
  ...
  QueryBuilder<Reminder, Reminder, QAfterFilterCondition> medicineIdEqualTo(
    String value, {
  ...
  QueryBuilder<Reminder, Reminder, QAfterFilterCondition> medicineIdGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Reminder, Reminder, QAfterFilterCondition> medicineIdLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Reminder, Reminder, QAfterFilterCondition> medicineIdBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Reminder, Reminder, QAfterFilterCondition> medicineIdStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Reminder, Reminder, QAfterFilterCondition> medicineIdEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Reminder, Reminder, QAfterFilterCondition> medicineIdContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Reminder, Reminder, QAfterFilterCondition> medicineIdMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Reminder, Reminder, QAfterFilterCondition> medicineIdIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'medicineId',
        value: '',
...
extension ReminderQuerySortBy on QueryBuilder<Reminder, Reminder, QSortBy> {
  ...
  QueryBuilder<Reminder, Reminder, QAfterSortBy> sortByMedicineId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'medicineId', Sort.asc);
    });
  }

  QueryBuilder<Reminder, Reminder, QAfterSortBy> sortByMedicineIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ReminderQuerySortThenBy
  ...
  QueryBuilder<Reminder, Reminder, QAfterSortBy> thenByMedicineId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'medicineId', Sort.asc);
    });
  }

  QueryBuilder<Reminder, Reminder, QAfterSortBy> thenByMedicineIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'medicineId', Sort.desc);
    });
  }
...
extension ReminderQueryWhereDistinct
  ...
  QueryBuilder<Reminder, Reminder, QDistinct> distinctByMedicineId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ReminderQueryProperty
  ...
  QueryBuilder<Reminder, String, QQueryOperations> medicineIdProperty() {
    return QueryBuilder.apply(this, (query) {
